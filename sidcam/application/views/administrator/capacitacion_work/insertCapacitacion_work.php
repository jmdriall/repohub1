...
<h1><?php echo lang('backend_insert_capacitacion_work'); ?></h1>
...
<?php echo form_open_multipart('administrator/capacitacion_work/insertCapacitacion_work/'.$trabajador_id, array('class'=>'cmxform', 'id'=>'insertform')); ?>
<table width="80%" align="center" border="0" cellspacing="0" cellpadding="6">
    ...
    <tr>
        <td align="right" valign="top"><strong>*<?php echo lang('backend_capacitacion'); ?>:</strong></td>
                ...
                <?php if($capacitaciones){
                    ...
                    foreach($capacitaciones as $row){
                        ...
                        foreach($capacitacion_workes as $accidentados){
                            if($accidentados->capacitacion_id == $row->capacitacion_id){
                                $key = 1;
                            }
                        }
                        if($key == 0){
    ...
    <tr>
        ...
        <td id="e"><?php echo form_input(array('name'=>'fecha', 'id'=>'fecha', 'value'=>$this->input->post('fecha', TRUE),'size'=>'80', 'type'=>'date')); ?>
    </tr>
    <tr>
