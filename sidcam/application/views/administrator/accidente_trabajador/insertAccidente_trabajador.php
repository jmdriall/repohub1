...
<h1><?php echo lang('backend_insert_accidente_trabajador'); ?></h1>
...
<?php echo form_open_multipart('administrator/accidente_trabajador/insertAccidente_trabajador/'.$accidente_id, array('class'=>'cmxform', 'id'=>'insertform')); ?>
<table width="80%" align="center" border="0" cellspacing="0" cellpadding="6">
    ...
    <tr>
        ...
        <td id="e" style="display: none"><?php echo form_input(array('name'=>'nombre', 'id'=>'nombre', 'value'=>$this->input->post('nombre', TRUE),'size'=>'80')); ?>
    </tr>
    <tr>
