...
<h1><?php echo lang('backend_update_epp'); ?></h1>
...
<?php echo form_open_multipart('administrator/epp/updateEpp', array('class'=>'cmxform', 'id'=>'updateform')); ?>
<table width="80%" align="center" border="0" cellspacing="0" cellpadding="6">
    ...
    <tr style="display:none;">
        <td align="right" valign="top"><strong><?php echo lang('backend_epp_sub_title'); ?>:</strong></td>
...
<?php
	echo br();
	echo form_hidden('epp_id', $epp_id);
echo form_hidden('user_id', $user_id);
    ...
    echo ' ';
    echo form_button(array('id' => 'cancel_button', 'name' => 'cancel', 'content' => lang('backend_cancel'), 'onclick' => "javascript: window.location.href='".site_url('administrator/epp/index/'.$user_id)."'"));
?>
        </td>
    </tr>
</table>
