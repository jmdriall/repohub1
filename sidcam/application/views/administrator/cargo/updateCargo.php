...
<h1><?php echo lang('backend_update_cargo'); ?></h1>
...
<?php echo form_open_multipart('administrator/cargo/updateCargo', array('class'=>'cmxform', 'id'=>'updateform')); ?>
<table width="80%" align="center" border="0" cellspacing="0" cellpadding="6">
    ...
    <tr style="display:none;">
        <td align="right" valign="top"><strong><?php echo lang('backend_cargo_sub_nombre'); ?>:</strong></td>
        <td align="left"><?php echo form_input('sub_nombre', $sub_nombre, 'size=80'); ?>
            <?php echo form_error('sub_nombre'); ?>
        </td>
    </tr>
    <tr style="display: none">
...
<?php
	echo br();
	echo form_hidden('cargo_id', $cargo_id);
echo form_hidden('user_id', $user_id);
    ...
    echo ' ';
    echo form_button(array('id' => 'cancel_button', 'name' => 'cancel', 'content' => lang('backend_cancel'), 'onclick' => "javascript: window.location.href='".site_url('administrator/cargo/index/'.$user_id)."'"));
?>
        </td>
    </tr>
</table>
