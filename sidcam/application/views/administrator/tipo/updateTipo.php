...
<h1><?php echo lang('backend_update_tipo'); ?></h1>
...
<?php echo form_open_multipart('administrator/tipo/updateTipo', array('class'=>'cmxform', 'id'=>'updateform')); ?>
<table width="80%" align="center" border="0" cellspacing="0" cellpadding="6">
    ...
    <tr style="display:none;">
        <td align="right" valign="top"><strong><?php echo lang('backend_tipo_sub_nombre'); ?>:</strong></td>
...
<?php
	echo br();
	echo form_hidden('tipo_id', $tipo_id);
