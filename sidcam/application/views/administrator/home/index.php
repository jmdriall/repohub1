...
<ul class="general_option">
    ...
    <li class="add_button"><?php echo anchor('administrator/slider/index', 'Gestionar Sliders');?></li>
    <li class="add_button"><?php echo anchor('administrator/user/updateUser/1', lang('backend_Edit_Admin'));?></li>
</ul>
<hr />
        ...
        foreach ($users->result() as $row)
        {
            ...
            if($row->user_id != 1)
            {
                ...
                <tr <?php echo $background; ?>>
                    ...
                    <td align="center"><?php echo anchor('administrator/home/copyindex/'.$row->user_id , $row->firstname); ?></td>
                    <td align="center"><?php echo $row->lastname; ?></td>
                    <td align="center"><?php echo anchor('administrator/user/updateUser/'.$row->user_id , lang('backend_edit')); ?></td>
                    <td align="center"><?php echo anchor('administrator/user/deleteUser/'.$row->user_id , lang('backend_delete')); ?></td>
                    <td align="center"><?php echo anchor('administrator/home/copyindex/'.$row->user_id , lang('backend_configurar')); ?></td>
