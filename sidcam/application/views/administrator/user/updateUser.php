...
<ul class="general_option">
    <li class="list_button"><?php echo anchor('administrator', lang('backend_list_users'));?></li>
</ul>
<hr />
...
<table width="80%" align="center" border="0" cellspacing="0" cellpadding="6">
  ...
  <tr>
	<td colspan="2" align="center">
	  ...
	  echo ' ';
	  echo form_button(array('name'=>'cancel', 'content'=>lang('backend_cancel'), 'id'=>'cancel_button','onclick'=>"javascript: window.location.href='".site_url('administrator/')."'"));
      ?>
   	</td>
  </tr>
</table>
