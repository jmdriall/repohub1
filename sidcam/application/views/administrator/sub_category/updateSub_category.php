...
<!-- [Content] start -->
<h1><?php echo lang('backend_update_sub_category'); ?></h1>
...
<?php echo form_open_multipart('administrator/sub_category/updateSub_category/'.$sub_category_id, array('class'=>'cmxform', 'id'=>'updateform')); ?>
<table width="80%" align="center" border="0" cellspacing="0" cellpadding="6">
    ...
    <tr>
        ...
        <td valign="top">
            <?php
            echo $picture. br();
            echo '<strong>solo archivo tipo "pdf"'. br().'</strong>';
			echo form_upload('picture', 'size=80');
            ?>
            <div class="warning">
