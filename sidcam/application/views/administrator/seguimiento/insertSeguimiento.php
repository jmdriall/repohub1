...
<h1><?php echo lang('backend_insert_seguimiento'); ?></h1>
<ul class="general_option">
    <li class="list_button"><?php echo anchor('administrator/seguimiento/index/'.$user_id,lang('backend_list_seguimientos'));?></li>
</ul>
<hr />

<?php echo form_open_multipart('administrator/seguimiento/insertSeguimiento/'.$user_id, array('class'=>'cmxform', 'id'=>'insertform')); ?>
