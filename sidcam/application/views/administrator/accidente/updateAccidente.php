...
<h1><?php echo lang('backend_update_accidente'); ?></h1>
<br />
<hr />

<?php echo form_open_multipart('administrator/accidente/updateAccidente', array('class'=>'cmxform', 'id'=>'updateform')); ?>
<table width="80%" align="center" border="0" cellspacing="0" cellpadding="6">
    ...
    <tr>
        ...
        <td><?php echo form_input('dias_perdidos', $dias_perdidos, 'size=80'); ?>
