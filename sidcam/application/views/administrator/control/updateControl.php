...
<h1><?php echo lang('backend_update_control'); ?></h1>
...
<?php echo form_open_multipart('administrator/control/updateControl', array('class'=>'cmxform', 'id'=>'updateform')); ?>
<table width="80%" align="center" border="0" cellspacing="0" cellpadding="6">
    ...
    <tr>
        ...
        <td align="left"><?php echo form_input(array('name'=>'fecha_control','value'=>$fecha_control,'type'=>'date')); ?>
