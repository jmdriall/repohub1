...
<h1><?php echo lang('backend_update_trabajador'); ?></h1>
...
<?php echo form_open_multipart('administrator/trabajador/updateTrabajador', array('class'=>'cmxform', 'id'=>'updateform')); ?>
<table width="80%" align="center" border="0" cellspacing="0" cellpadding="6">
    ...
    <tr>
        ...
        <td align="left"><?php echo form_input('apellidos', $apellidos, 'size=80'); ?>
    ...
    <tr>
        ...
        <td align="left"><?php echo form_input('dni', $dni, 'size=80'); ?>
