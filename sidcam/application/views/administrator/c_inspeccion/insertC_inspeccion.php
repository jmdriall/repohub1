...
<h1><?php echo lang('backend_insert_c_inspeccion'); ?></h1>
<ul class="general_option">
    <li class="list_button"><?php echo anchor('administrator/c_inspeccion/index/', lang('backend_list_c_inspeccions'));?></li>
</ul>
<hr />

<?php echo form_open_multipart('administrator/c_inspeccion/insertC_inspeccion/'.$inspeccion_id, array('class'=>'cmxform', 'id'=>'insertform')); ?>
<table width="80%" align="center" border="0" cellspacing="0" cellpadding="6">
    ...
    <tr>
        ...
        <td><?php echo form_textarea(array('id' => 'evidencia', 'name' => 'evidencia', 'rows' => '12', 'cols' => '52', 'value' => $this->input->post('evidencia',TRUE))); ?>
            <?php echo form_error('evidencia'); ?>
        </td>
    </tr>
    <tr>
        <td align="right" valign="top"><strong>*<?php echo lang('backend_fecha_c_inspeccion'); ?>:</strong></td>
        <td><?php echo form_input(array('name'=>'fecha_c_inspeccion', 'value' => $this->input->post('fecha_c_inspeccion', TRUE), 'size'=>'80', 'type'=>'date')); ?>
