...
<!-- [Content] start -->
<h1><?php echo lang('backend_update_archivo'); ?></h1>
...
<?php echo form_open_multipart('administrator/archivo/updateArchivo/'.$archivo_id, array('class'=>'cmxform', 'id'=>'updateform')); ?>
                ...
                <?php if($tipos){
                    foreach($tipos as $tipo){
                        if($tipo->tipo_id != $tipo_id)
                            ...
                            echo "<option value='$tipo->tipo_id' selected> $tipo->nombre </option>";
                    }
                } ?>
            </select>
...
<?php
	...
	echo form_hidden('first_image', $picture);
