...
<h1><?php echo lang('backend_update_capacitacion'); ?></h1>
...
<?php echo form_open_multipart('administrator/capacitacion/updateCapacitacion', array('class'=>'cmxform', 'id'=>'updateform')); ?>
<table width="80%" align="center" border="0" cellspacing="0" cellpadding="6">
    ...
    <tr style="display:none;">
        <td align="right" valign="top"><strong><?php echo lang('backend_capacitacion_sub_title'); ?>:</strong></td>
...
<?php
	echo br();
	echo form_hidden('capacitacion_id', $capacitacion_id);
