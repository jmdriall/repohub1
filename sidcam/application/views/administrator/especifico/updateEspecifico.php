...
<h1><?php echo lang('backend_update_especifico'); ?></h1>
...
<?php echo form_open_multipart('administrator/especifico/updateEspecifico', array('class'=>'cmxform', 'id'=>'updateform')); ?>
