...
<h1><?php echo lang('backend_insert_objetivo'); ?></h1>
<ul class="general_option">
    <li class="list_button"><?php echo anchor('administrator/objetivo/index/'.$user_id,lang('backend_list_objetivos'));?></li>
</ul>
<hr />

<?php echo form_open_multipart('administrator/objetivo/insertObjetivo', array('class'=>'cmxform', 'id'=>'insertform')); ?>
<table width="80%" align="center" border="0" cellspacing="0" cellpadding="6">
    ...
    <tr style="display:none;">
        <td align="right" valign="top"><strong><?php echo lang('backend_objetivo_sub_title'); ?>:</strong></td>
...
<?php
    ...
    echo ' ';
    echo form_button(array('id' => 'cancel_button', 'name' => 'cancel', 'content' => lang('backend_cancel'), 'onclick' => "javascript: window.location.href='".site_url('administrator/objetivo/index/'.$user_id)."'"));
?>
        </td>
    </tr>
</table>
