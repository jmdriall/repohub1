...
<h1><?php echo lang('backend_update_medida_correctiva'); ?></h1>
...
<?php echo form_open_multipart('administrator/medida_correctiva/updateMedida_correctiva', array('class'=>'cmxform', 'id'=>'updateform')); ?>
<table width="80%" align="center" border="0" cellspacing="0" cellpadding="6">
    ...
    <tr>
        ...
        <td align="left"><?php echo form_input('medida', $medida, 'size=80'); ?>
            <?php echo form_error('medida'); ?>
        </td>
    </tr>
    <tr>
        <td align="right" valign="top"><strong><?php echo lang('backend_fecha_medida_correctiva'); ?>:</strong></td>
        <td align="left"><?php echo form_input(array('name'=>'fecha_medida_correctiva','value'=>$fecha_medida_correctiva,'type'=>'date')); ?>
