...
<h1><?php echo lang('backend_insert_medida_correctiva'); ?></h1>
...
<?php echo form_open_multipart('administrator/medida_correctiva/insertMedida_correctiva/'.$accidente_id, array('class'=>'cmxform', 'id'=>'insertform')); ?>
<table width="80%" align="center" border="0" cellspacing="0" cellpadding="6">
    ...
    <tr>
        <td align="right" valign="top"><strong>*<?php echo lang('backend_medida'); ?>:</strong></td>
        <td><?php echo form_input('medida', $this->input->post('medida', TRUE), 'size=80'); ?>
    ...
    <tr>
        <td align="right" valign="top"><strong>*<?php echo lang('backend_fecha_medida_correctiva'); ?>:</strong></td>
        <td><?php echo form_input(array('name'=>'fecha_medida_correctiva', 'value' => $this->input->post('fecha_medida_correctiva', TRUE), 'size'=>'80', 'type'=>'date')); ?>
...
<?php
    ...
    echo ' ';
    echo form_button(array('id' => 'cancel_button', 'name' => 'cancel', 'content' => lang('backend_cancel'), 'onclick' => "javascript: window.location.href='".site_url('administrator/medida_correctiva/index/'.$accidente_id)."'"));
?>
        </td>
    </tr>
</table>
