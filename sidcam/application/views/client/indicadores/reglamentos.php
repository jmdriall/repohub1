        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="row indices">
                    ...
                    <div class="col-xs-7">
                        <h3><strong>Actualizar reglamentos</strong></h3>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xs-12">
                <?php foreach($trabajadores as $trabajador){ ?>
                        <div class="row" style="background-color: <?php if($aux){echo '#dad8d8';$aux = false;} else {echo '#c7c3c3'; $aux = true;} ?>">
                            ...
                            <div class="col-xs-7">
                                <?php echo anchor('client/indicadores/subirRegla/'.$trabajador->trabajador_id, 'subir') ?>
                                <?php echo anchor('client/indicadores/quitarRegla/'.$trabajador->trabajador_id, 'quitar') ?>
                                <?php if($trabajador->regla_recomendaciones == 1){ ?>
                                    <span style="color: #2b542c;font-size: 17px;font-weight: bold;">Con Documento</span>
                                <?php } ?>
                            </div>
                        </div>
