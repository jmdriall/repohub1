...
<?php echo form_open_multipart('client/indicadores/observacionAuditoria', array('class'=>'cmxform', 'id'=>'updateform')); ?>
<h1 style="text-align: center; margin-top: 20px;"><?php echo 'Observaciones Auditoria' ?></h1>
