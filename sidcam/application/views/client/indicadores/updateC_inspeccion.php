...
<div class="container">
    <h1 class="mar-top-15 text-center"><?php echo lang('backend_update_c_inspeccion'); ?></h1>

    <?php echo form_open_multipart('client/indicadores/updateC_inspeccion', array('class'=>'cmxform', 'id'=>'updateform')); ?>
    <div class="row">

        <div class="col-xs-2 mar-top-15"><strong>*<?php echo lang('backend_responsable'); ?>:</strong></div>
        <div class="col-xs-10 mar-top-15">
            <?php echo form_input(array('name'=>'responsable','value'=> $responsable, 'size'=>'80','class'=>'form-c_inspeccion')); ?>
        ...
        <div class="col-xs-2 mar-top-15"><strong>Fecha C_inspeccion</strong></div>
        <div class="col-xs-10 mar-top-15">
            <?php echo form_input(array('name'=>'fecha_c_inspeccion', 'value' => $fecha_c_inspeccion, 'size'=>'80', 'type'=>'date')); ?>
        ...
        <div class="col-xs-10">
            ...
            echo form_submit(array('id' => 'submit_button', 'name' => 'update', 'value' => lang('backend_save'), 'class' => 'input-submit form-c_inspeccion','style'=>'width:auto!important;float:left; margin-right:10px'));
