...
<?php echo form_open_multipart('client/indicadores/insertAccidente', array('class'=>'cmxform', 'id'=>'insertform')); ?>
<h1 style="text-align: center; margin-top: 20px;"><?php echo 'Insert Accidente' ?></h1>
<br />
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="row">
                ...
                <div class="col-xs-2"><strong>Dias Perdidos</strong></div>
                <div class="col-xs-10">
                ...
                <div class="col-xs-2 mar-top-15"><strong>*<?php echo lang('backend_area'); ?>:</strong></div>
