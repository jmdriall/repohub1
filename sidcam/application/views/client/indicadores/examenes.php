            ...
            <div class="col-xs-12">
                <?php foreach($trabajadores as $trabajador){ ?>
                        <div class="row" style="background-color: <?php if($aux){echo '#dad8d8';$aux = false;} else {echo '#c7c3c3'; $aux = true;} ?>">
                            ...
                            <div class="col-xs-7">
                                <?php echo anchor('client/indicadores/subirExamen/'.$trabajador->trabajador_id, 'subir') ?>
                                <?php echo anchor('client/indicadores/quitarExamen/'.$trabajador->trabajador_id, 'quitar') ?>
                                <?php if($trabajador->examen_medico == 1){ ?>
