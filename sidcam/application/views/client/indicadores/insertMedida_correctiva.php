...
<div class="container">
    <h1 class="mar-top-15 text-center"><?php echo lang('backend_insert_medida_correctiva'); ?></h1>

    <?php echo form_open_multipart('client/indicadores/insertMedida_correctiva/'.$accidente_id, array('class'=>'cmxform', 'id'=>'insertform')); ?>
    <div class="row">
        ...
        <div class="col-xs-10 mar-top-15">
            <?php echo form_input(array('name'=>'fecha_medida_correctiva', 'value' => $this->input->post('fecha_medida_correctiva', TRUE), 'size'=>'80', 'type'=>'date')); ?>
