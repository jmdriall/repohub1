...
<?php echo form_open_multipart('client/indicadores/evidenciaMedidaCorrectiva', array('class'=>'cmxform', 'id'=>'updateform')); ?>
            ...
            <div class="row mar-top-15">
                <div class="col-xs-12" style="margin-left: -15px;">
                    <div class="row">
                        ...
                        <div class="col-xs-11">
                            <input type="button" class="form-control" onclick="javascript: window.location.href='<?php echo site_url('client/indicadores/medidaCorrectiva/'.$accidente_id)?>'" value="Cancelar" style="width: 70px!important;margin-top: 20px"/>
                        </div>
                    </div>
