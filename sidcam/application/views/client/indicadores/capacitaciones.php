            ...
            <div class="col-xs-12">
                <?php foreach($trabajadores as $trabajador){ ?>
                        <div class="row" style="background-color: <?php if($aux){echo '#dad8d8';$aux = false;} else {echo '#c7c3c3'; $aux = true;} ?>">
                            ...
                            <div class="col-xs-7">
                                <?php echo anchor('client/indicadores/capacitacionWork/'.$trabajador->trabajador_id, 'Actualizar') ?>
                                <?php if ($this->capacitacion_work_model->getAll($trabajador->trabajador_id)){if(count($this->capacitacion_work_model->getAll($trabajador->trabajador_id)) == $count_capacitacion){ ?>
