...
<?php echo form_open_multipart('client/indicadores/updateAccidente', array('class'=>'cmxform', 'id'=>'updateform')); ?>
<h1 style="text-align: center; margin-top: 20px;"><?php echo 'Editar Accidente' ?></h1>
<br />
