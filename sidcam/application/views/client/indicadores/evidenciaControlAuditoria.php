...
<?php echo form_open_multipart('client/indicadores/evidenciaControlAuditoria', array('class'=>'cmxform', 'id'=>'updateform')); ?>
<h1 style="text-align: center; margin-top: 20px;"><?php echo 'Evidencia Control Auditoria' ?></h1>
<h2 style="text-align: center; margin-top: 20px;"> <?php echo $responsable; ?></h2>
<br />
...
<div class="container">
    <div class="row">
        <div class="col-xs-12">
            <div class="row">
                <div class="col-xs-12">
                    <textarea name="evidencia" id="evidencia" cols="30" rows="10" class="form-control"><?php echo $evidencia; ?></textarea>
            ...
            <div class="row mar-top-15">
                <div class="col-xs-12" style="margin-left: -15px;">
                    <div class="row">
                        ...
                        <div class="col-xs-11">
                            <input type="button" class="form-control" onclick="javascript: window.location.href='<?php echo site_url('client/indicadores/controlAuditorias/'.$seguimiento_id)?>'" value="Cancelar" style="width: 70px!important;margin-top: 20px"/>
                        </div>
                    </div>
    ...
    <tr>
        ...
        <td align="left">
            <?php
            echo form_hidden('control_id', $control_id);
