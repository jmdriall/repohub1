...
<?php echo form_open_multipart('client/indicadores/insertAuditoria', array('class'=>'cmxform', 'id'=>'insertform')); ?>
<h1 style="text-align: center; margin-top: 20px;"><?php echo 'Insert Auditoria' ?></h1>
<br />
