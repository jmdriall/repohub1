...
<div class="container">
    <h1 class="mar-top-15 text-center"><?php echo lang('backend_update_control'); ?></h1>

    <?php echo form_open_multipart('client/indicadores/updateControl', array('class'=>'cmxform', 'id'=>'updateform')); ?>
    <div class="row">
        ...
        <div class="col-xs-10 mar-top-15">
            <?php echo form_input(array('name'=>'fecha_control', 'value' => $fecha_control, 'size'=>'80', 'type'=>'date')); ?>
