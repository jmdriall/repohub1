...
<?php echo form_open_multipart('client/indicadores/updateAuditoria', array('class'=>'cmxform', 'id'=>'updateform')); ?>
<h1 style="text-align: center; margin-top: 20px;"><?php echo 'Editar Auditoria' ?></h1>
<br />
