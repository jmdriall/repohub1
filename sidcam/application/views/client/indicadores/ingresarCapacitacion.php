...
<?php echo form_open_multipart('client/indicadores/ingresarCapacitacion/'.$trabajador_id, array('class'=>'cmxform', 'id'=>'insertform')); ?>
<h1 style="text-align: center; margin-top: 20px;"><?php echo 'Ingresar Capacitaciones' ?></h1>
<br />
...
<div class="container">
    <div class="row">
        <div class="col-xs-12">
            <div class="row">
                <div class="col-xs-2">
                    <h3><strong>*Capacitacion</strong></h3>
                </div>
                <div class="col-xs-10">
