...
<div class="body">
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-12">
                <h1 class="padding_article_left">POL&Iacute;TICA</h1>
            </div>
        </div>
        <div class="row" style="text-align: left">
            ...
            <?php $comodin = true;
                if($archivos_politica){
                   foreach($archivos_politica as $archivo){
                    ?>
                    <div class="archivo col-xs-12" id="<?php echo $archivo->title;?>" style="background-color: #<?php if($comodin){echo 'dad8d8';$comodin=false;}else{echo 'c7c3c3';$comodin=true;} ?>;">
                        <div class="row">
                            ...
                            <div class="col-xs-6 col-sm-2">
                                <a href="<?php echo base_url().'resources/media/archivo/doc/' . $user_login . '/politica/' . $archivo->picture ?>" download="<?php echo $archivo->picture ?>">descargar</a>
                            </div>
                        </div>
                    </div>
                   <?php }
