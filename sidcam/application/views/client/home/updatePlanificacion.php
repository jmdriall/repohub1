...
<?php echo form_open_multipart('client/home/updatePlanificacion/'.$planificacion_id, array('class'=>'cmxform', 'id'=>'updateform')); ?>
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                ...
                <input type="button" class="form-control" onclick="javascript: window.location.href='<?php echo site_url('client/home/index/')?>'" value="Cancelar" style="width: 70px!important;margin-top: 20px"/>
            </div>
        </div>
    </div>
